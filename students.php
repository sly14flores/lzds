      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="page-title" style="overflow: hidden">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 form-group top_search">
                  <div class="input-group">
                    <input type="text" class="form-control" ng-model="views.search" placeholder="Quick Search" ng-disabled="views.list">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="javascript:;" ng-click="form.student(this,null)">Add New Student</a></li>
                          <li><a href="javascript:;" ng-click="form.list(this)">Students List</a></li>
                        </ul>
                      </li>
