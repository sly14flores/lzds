              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                    <select class="form-control" ng-model="filter.school_year" ng-options="sy as sy.school_year for sy in school_years track by sy.id" ng-disabled="views.list">
                  ...
                  <div class="input-group">
                    <select class="form-control" ng-model="filter.level" ng-options="l as l.description for l in levels track by l.id" ng-disabled="views.list">
						<option value="0">Level</option>
					</select>
                    <span class="input-group-btn">
                      <button class="btn btn-default" type="button" ng-click="form.list(this)">Go!</button>
                    </span>
                  </div>				  
                  <div class="input-group">
                    <input type="text" class="form-control" ng-model="views.search" placeholder="Search for..." ng-disabled="views.list">
                    <span class="input-group-btn">
                      <button class="btn btn-default" type="button" ng-click="form.list(this)">&nbsp;</button>
                    </span>
                  </div>
                </div>
              </div>
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="javascript:;" ng-click="form.list(this)">Payments List</a></li>
                          <li ng-show="enrollment_info.id != undefined"><a href="javascript:;" ng-click="form.soa(this)">Preview SOA Email</a></li>
                          <li ng-show="enrollment_info.id == undefined"><a href="javascript:;" ng-click="form.emailBulk(this)">Send bulk SOA Emails</a></li>
                        </ul>
                      </li>
