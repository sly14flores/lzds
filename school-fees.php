...
<html lang="en">
  ...
  <body id="main-body" class="nav-md" ng-app="fees" ng-controller="feesCtrl" account-profile>
              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                    <select class="form-control" ng-model="filter.school_year" ng-options="sy as sy.school_year for sy in school_years_ track by sy.id" ng-disabled="views.list">
						<option value="0">SY</option>
					</select>
                    <span class="input-group-btn">
                      <button class="btn btn-default" type="button" ng-click="form.list(this,'fee')">Go!</button>
                    </span>
                  </div>				
                  <div class="input-group">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="javascript:;" ng-click="form.fee(this,null)">Add New Fee</a></li>
                          <li><a href="javascript:;" ng-click="form.list(this,'fee')">Fees List (View by Fee)</a></li>
                          <li><a href="javascript:;" ng-click="form.list(this,'level')">Fees List (View by Level)</a></li>
                        </ul>
                      </li>
	...
	<script src="modules/fees.js<?=$update?>"></script>
	
	<script src="controllers/fees.js<?=$update?>"></script>
