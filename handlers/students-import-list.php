...
$sql = "SELECT enrollee_id, enrollee_fid, enrollee_lname, enrollee_fname, enrollee_mname, enrollee_sy FROM enrollees";
if ( (isset($_POST['q'])) && ($_POST['q'] != "") ) $sql .= " WHERE CONCAT(enrollee_lname, ' ', enrollee_fname, ' ', enrollee_mname) = '".$_POST['q']['fullname']."'";
$sql .= " ORDER BY enrollee_lname, enrollee_fname, enrollee_mname, enrollee_sy";
