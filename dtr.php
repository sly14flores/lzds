...
<html lang="en">
  ...
  <body id="main-body" class="nav-md" ng-app="dtr" ng-controller="dtrCtrl" account-profile>
                  ...
                  <div class="x_content">
                    <form name="formHolder.staff" id="formHolder.staff">
					  <div class="form-group">
						<label>Year :</label>
						<input type="text" class="form-control" ng-model="staffDtr.year">
					  </div>
                      <label>Month :</label>
                      <select class="form-control" ng-model="staffDtr.month" ng-options="m.description for m in months track by m.month"></select>
                      <label>Staff :</label>
                      <!-- <input type="text" class="form-control" ng-model="staffDtr.fullname" uib-typeahead="fullname as ss.fullname for ss in suggest_staffs | filter:{fullname:$viewValue}" typeahead-on-select="form.staffSelect(this, $item, $model, $label, $event)"> -->
                      <select class="form-control" ng-model="staffDtr.staff" ng-options="ss.full_name for ss in suggest_staffs track by ss.id" ng-change="form.staffSelected(this)"></select>
                      <br/>
				...
				<div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form name="formHolder.downloadDtr" id="formHolder.downloadDtr">
                      <label>By :</label>
                      <select class="form-control" name="month" ng-model="downloadDtr.by">
	...
	<script src="modules/dtr.js<?=$update?>"></script>
	
	<script src="controllers/dtr.js<?=$update?>"></script>
