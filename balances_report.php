...
<html lang="en">
  ...
  <body id="main-body" class="nav-md" ng-app="balancesReport" ng-controller="balancesReportCtrl" account-profile>
                  ...
                  <div id="x_content" class="x_content">
                    <form>
					  <div class="form-group">
						...
						<select class="form-control" ng-model="report.balances.school_year" ng-options="sy as sy.school_year for sy in school_years_ track by sy.id"></select>
					  </div>
                      <label>Level :</label>
                      <select class="form-control" ng-model="report.balances.level" ng-options="level as level.description for level in levels_ track by level.id" ng-change="form.levelSelected(this,report.balances.level)"></select>
                      <label>Section :</label>
                      <select class="form-control" ng-model="report.balances.section" ng-options="section as section.description for section in sections track by section.id"></select>
                      <br/>
                      <span class="btn btn-primary pull-right" ng-click="form.balances(this)">Generate!</span>
                    </form>					
				  </div>
                </div>
              </div>
