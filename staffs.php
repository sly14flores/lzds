...
<html lang="en">
  ...
  <body id="main-body" class="nav-md" ng-app="staffs" ng-controller="staffsCtrl" account-profile>
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="javascript:;" ng-click="form.staff(this,null)">Add New Staff</a></li>
                          <li><a href="javascript:;" ng-click="form.list(this)">Staffs List</a></li>
                        </ul>
                      </li>
	...
	<script src="modules/records.js?ver=1.0.1"></script>	
