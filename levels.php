...
<html lang="en">
  ...
  <body id="main-body" class="nav-md" ng-app="levels" ng-controller="levelsCtrl" account-profile>
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="javascript:;" ng-click="form.level(this,null)">Add New Level</a></li>
                          <li><a href="javascript:;" ng-click="form.level(this)">Levels List</a></li>
                        </ul>
                      </li>
	...
	<script src="modules/levels.js<?=$update?>"></script>
	
	<script src="controllers/levels.js<?=$update?>"></script>
