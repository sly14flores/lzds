...
<html lang="en">
  ...
  <body id="main-body" class="nav-md" ng-app="dashboard" ng-controller="dashboardCtrl" account-profile>
          ...
          <div class="">
            <div class="page-title">
              ...
              <div class="title_right">			  
				<form class="form-inline pull-right" name="formHolder.school_year">
				  <div class="form-group" ng-class="{'has-error': formHolder.school_year.from.$touched && formHolder.school_year.from.$invalid}">
					<label>From</label>
					<select class="form-control" name="from" ng-model="filter.from" ng-options="sy.school_year for sy in school_years track by sy.id" required></select>
				  </div>
				  <div class="form-group" ng-class="{'has-error': formHolder.school_year.to.$touched && formHolder.school_year.to.$invalid}">
					<label>To</label>
	...
	<script src="modules/dashboard.js<?=$update?>"></script>
	
	<script src="controllers/dashboard.js<?=$update?>"></script>
