...
<html lang="en">
  ...
  <body id="main-body" class="nav-md" ng-app="schoolYears" ng-controller="schoolYearsCtrl" account-profile>
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="javascript:;" ng-click="schoolYears.form(this,null)">Add New School Year</a></li>
                          <li><a href="javascript:;" ng-click="schoolYears.list(this)">School Years List</a></li>
                        </ul>
                      </li>
