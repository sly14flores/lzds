angular.module('summary-report-module', ['ui.bootstrap','bootstrap-modal','pnotify-module','block-ui','school-year','jspdf-module','module-access']).factory('form', function($http,$timeout,$compile,bootstrapModal,pnotify,blockUI,schoolYear,jspdf,access) {
	...
	function form() {
		...
		self.data = function(scope) { // initialize data
			...
			scope.report.summary.school_year = {id: 0, school_year: "-"};
			
			scope.report.collections = {};
			scope.report.collections.school_year = {id: 0, school_year: "-"};			
			...
			$http({
			  ...
			  url: 'handlers/current-sy.php'
				...
				scope.report.summary.school_year = response.data;
				scope.report.collections.school_year = response.data;
		...
		self.collections = function(scope) {
			
			if (!access.has(scope,scope.module.id,scope.module.privileges.generate_report)) return;
			
			if (scope.report.collections.school_year.id == 0) {
				pnotify.show('error','Notification','Please select school year.');
				return;				
			};

			if (validate(scope,'collections')) return;
			
			blockUI.show();			
			
			$http({
			  method: 'POST',
			  url: 'handlers/report-collections.php',
			  data: scope.report.collections
			}).then(function mySucces(response) {

				blockUI.hide();			
				collections(scope,response.data);
		...
		function collections(scope,collections) {
			
			var coverage = scope.report.collections.coverage;
			var coverage_details = '';
			
			var d = new Date();
			var months = ["January","February","March","April","May","June","July","August","September","October","November","December"];			
			
			switch (scope.report.collections.coverage) {
				
				case 'Daily':

					var date = scope.report.collections.date;
					coverage_details = '('+months[date.getMonth()]+' '+date.getDate()+', '+date.getFullYear()+')';
				...
				case 'Weekly':
					...
					var dateFrom = scope.report.collections.week_from;
					var dateTo = scope.report.collections.week_to;
				...
				case 'Monthly':
					...
					coverage_details = '('+scope.report.collections.month.description+', '+scope.report.collections.year+')';
				
				break;

				case 'Annually':									
				
					coverage_details = '('+scope.report.collections.year+')';
			...
			// HEADER			
			doc.addImage('data:image/png;base64,', 'JPEG', 418, 20, 100, 100);
			...
			doc.setFontSize(12);
			doc.setFontType('bold');
			doc.myText("Collections",{align: "center"},0,182);
			
			doc.setFontSize(10);
			doc.setFontType('normal');
			doc.text(50, 213, 'Coverage: '+coverage);
			doc.text(160, 213, coverage_details);
			doc.text(800, 213, "SY: "+scope.report.summary.school_year.school_year);			
			...
			var collections_headers = [
				{title: "Date", dataKey: "payment_date"},
				{title: "Name", dataKey: "fullname"},				
				{title: "ID", dataKey: "school_id"},
				{title: "Grade", dataKey: "grade"},			
				{title: "Section", dataKey: "section"},
				{title: "Gender", dataKey: "gender"},
				{title: "Address", dataKey: "home_address"},
				{title: "OR", dataKey: "official_receipt"},
				{title: "Amount", dataKey: "amount"}
			];

			doc.autoTable(collections_headers, collections.data, {
				// tableLineColor: [189, 195, 199],
				// tableLineWidth: 0.75,
				// addPageContent: pageContent,
				startY: 220,
				margin: {left: 50, right: 30, bottom: 50},
				tableWidth: 500,
				showHeader: 'everyPage',				
				columnStyles: {
					payment_date: {columnWidth: 75},
					fullname: {columnWidth: 150},					
					school_id: {columnWidth: 90},					
					grade: {columnWidth: 100},
					section: {columnWidth: 85},
					gender: {columnWidth: 50},
					home_address: {columnWidth: 140},
					official_receipt: {columnWidth: 50},
					amount: {columnWidth: 90}
				},
				styles: {
					lineColor: [75, 75, 75],
					lineWidth: 0.50,
			...
			doc.setFontSize(12);
			doc.setFontType('bold');			
			doc.text("Total: "+collections.total, 700, doc.autoTableEndPosY()+30);
		...
		self.reset = {
			...
			collections: function(scope) {
				...
				var controls = scope.formHolder.collections.$$controls;
