angular.module('records-module',['ui.bootstrap','bootstrap-modal']).factory('records',function($http,$timeout,$compile,bootstrapModal) {
	...
	function records() {
		...
		self.print = function(scope) {
			...
			function records(records) {
				...
				var obj = {
					...
					"Employee Performance Development and Improvement": {
						description: "Employee Performance Development and Improvement",
						data: []
					},
					"Employment Termination Records": {
						description: "Employment Termination Records",
						data: []
					}
				};
			...
			// console.log(records(scope.data.records));
			...
			doc.setFontSize(12);
			doc.setFontType('bold');
			doc.myText("RECORDS",{align: "center"},0,185);			
			
			doc.setFontSize(10);
			doc.text(50, 215, 'Full name:');
			doc.text(105, 215, scope.staff.lastname+', '+scope.staff.firstname+' '+scope.staff.middlename);
			doc.text(370, 215, 'Employment Status:');
			doc.text(475, 215, scope.staff.employment_status);
			
			var r = 245;
			
			angular.forEach(records(scope.data.records), function(item,i) {
				
				doc.setFontType('bold');
				doc.text(50, r, item.description);
