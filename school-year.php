...
<html lang="en">
  ...
  <body id="main-body" class="nav-md" ng-app="enrollmentsSchoolYear" ng-controller="enrollmentsSchoolYearCtrl" account-profile>
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="javascript:;" ng-click="form.enroll()">Enroll a student in the current school year</a></li>
                        </ul>
                      </li>
  ...
  <script src="angular/ui-bootstrap-tpls-2.5.0.min.js"></script>
	...
	<script src="modules/enrollments-school-year.js<?=$update?>"></script>
	
	<script src="controllers/enrollments-school-year.js<?=$update?>"></script>
