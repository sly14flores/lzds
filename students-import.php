...
<html lang="en">
  ...
  <body id="main-body" class="nav-md" ng-app="studentsImport" ng-controller="studentsImportCtrl" account-profile>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-group"></i> Profiles <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="students.html">Students</a></li>					
                      <li><a href="staffs.html">Staffs</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-suitcase"></i> Accounting <span class="fa fa-chevron-down"></span></a>				  
                    <ul class="nav child_menu">
                      <li><a href="cashier.html">Cashier</a></li>
                      <li><a href="dtr.html">DTR</a></li>
                      <li><a href="payroll.html">Payroll</a></li>					  
                    </ul>				  
                  </li>
                  <li><a><i class="fa fa-bar-chart-o"></i> Reports <span class="fa fa-chevron-down"></span></a>				  
                    <ul class="nav child_menu">
                      <li><a href="payments_report.html">Payments</a></li>				  
                    </ul>				  
                  </li>				  
                  <li class="active"><a><i class="fa fa-cogs"></i> Maintenance <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="levels.html">Grade Levels</a></li>					
                      <li><a href="school-fees.html">School Fees</a></li>
                      <li><a href="schedules.html">Schedules</a></li>
                      <li><a href="holidays.html">Holidays</a></li>					  
                      <li><a href="groups.html">Groups</a></li>
                      <li class="active"><a href="students-import.html">Import Students</a></li>					  
                    </ul>
                  </li>
                </ul>
              </div>
              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                    <input type="text" class="form-control" ng-model="views.search" placeholder="Search for...">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
				  <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="tile-stats">
					  ...
					  <div class="count">{{views.import_size}}</div>
					  <h3>Import Records</h3>
					  <p>{{views.import_enrollees}}</p>
					</div>
				  </div>				  
			  </div>
              <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="javascript:;" ng-click="form.import(this)">Import Records</a></li>
                          <li><a href="javascript:;" ng-click="form.clear(this)">Clear List</a></li>
                        </ul>
                      </li>
	...
	<script src="modules/students-import.js"></script>
	
	<script src="controllers/students-import.js"></script>
