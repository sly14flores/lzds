...
<html lang="en">
  ...
  <body id="main-body" class="nav-md" ng-app="holidays" ng-controller="holidaysCtrl" account-profile>
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="javascript:;" ng-click="form.holiday(this,null)">Add New Holiday</a></li>
                          <li><a href="javascript:;" ng-click="form.list(this)">Holidays List</a></li>
                        </ul>
                      </li>
	...
	<script src="modules/holidays.js<?=$update?>"></script>
	
	<script src="controllers/holidays.js<?=$update?>"></script>
