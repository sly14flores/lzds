...
<html lang="en">
  ...
  <body id="main-body" class="nav-md" ng-app="ids" ng-controller="idsCtrl" account-profile>
        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<form class="form-inline">
			  ...
			  <div class="form-group">
				<label>Level:</label>
				<select class="form-control" ng-model="filter.level" ng-options="level.description for level in levels track by level.id"></select>
			  </div>		  
			  <button type="button" class="btn btn-default" style="margin-top: 5px;" ng-click="form.filter(this)">Go!</button>
			</form>
			<hr>
            <div class="row">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="javascript:;" ng-click="form.generateIds(this)">Generate IDs</a></li>
                          <li><a href="javascript:;" ng-click="form.print(this)">Print List</a></li>
                        </ul>
                      </li>
	...
	<script src="modules/ids.js<?=$update?>"></script>
	
	<script src="controllers/ids.js<?=$update?>"></script>
