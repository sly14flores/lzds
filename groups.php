...
<html lang="en">
  ...
  <body id="main-body" class="nav-md" ng-app="groups" ng-controller="groupsCtrl" account-profile>
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="javascript:;" ng-click="form.group(this,null)">Add New Group</a></li>
                          <li><a href="javascript:;" ng-click="form.list(this)">Groups List</a></li>
                        </ul>
                      </li>
